    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans p-6">
      <header className="max-w-5xl mx-auto mb-8 border-b border-slate-800 pb-4">
        <h1 className="text-3xl font-extrabold tracking-tight text-indigo-400">
          MediaSoup Engine Integration <span className="text-sm font-normal text-slate-400 bg-slate-800 px-2 py-1 rounded ml-2">Sprint 4</span>
        </h1>
        <p className="text-slate-400 mt-1">Receive Pipeline Allocation Layer</p>
      </header>
